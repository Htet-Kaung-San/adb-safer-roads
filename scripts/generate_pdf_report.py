...
def make_styles():
    ...
    return {
        ...
        "body":     S("body",     fontSize=9.2, textColor=TEXT,    fontName="Helvetica",
                       leading=13.8, spaceAfter=5, alignment=TA_JUSTIFY),
        "bullet":   S("bullet",   fontSize=9.2, textColor=TEXT,    fontName="Helvetica",
                       leading=13.5, spaceAfter=3, leftIndent=14, firstLineIndent=-10),
